...
/** 에이전트 제어자 */
public abstract class CE20AgentController : CComponent {
	/** 매개 변수 */
	public record STParams {
		public CE20Engine m_oEngine = null;
		public System.Action<CE20AgentController, Vector3Int> m_oTouchCallback = null;
