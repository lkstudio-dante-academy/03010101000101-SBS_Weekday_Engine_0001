...
/** 객체 풀 관리자 */
public class CE15ObjsPoolManager : CComponent {
	#region 변수
	private Dictionary<System.Type, CPoolList<object>> m_oPoolListDict = new Dictionary<System.Type, CPoolList<object>>();
	#endregion // 변수

	#region 함수
	/** 객체를 활성화한다 */
	public object SpawnObj<T>(System.Func<object> a_oCreator) {
		var oPoolList = m_oPoolListDict.GetValueOrDefault(typeof(T)) ?? new CPoolList<object>();
