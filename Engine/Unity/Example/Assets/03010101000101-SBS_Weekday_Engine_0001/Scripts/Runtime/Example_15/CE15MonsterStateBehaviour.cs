...
/** 몬스터 상태 행동 처리 */
public class CE15MonsterStateBehaviour : StateMachineBehaviour
{
	#region 프로퍼티
	public System.Action<CE15MonsterStateBehaviour, Animator, AnimatorStateInfo, int> Callback { get; set; } = null;
	#endregion // 프로퍼티
