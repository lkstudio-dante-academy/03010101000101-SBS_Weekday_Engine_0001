...
public class CE20MatchingUIsHandler : CE20UIsHandler
{
	...
	public new record STParams : CE20UIsHandler.STParams
	{
		#region 함수
		/** 생성자 */
		public STParams(CExample_20 a_oSceneManager) : base(a_oSceneManager)
		{
			// Do Something
		}
		#endregion // 함수
		...
		STPacketInfo a_stPacketInfo)
	{
		...
		var oSceneManager = CSceneManager.GetSceneManager<CExample_20>(KDefine.G_SCENE_N_E20);
	...
	#region 클래스 팩토리 함수
	/** 매개 변수를 생성한다 */
	public new static STParams MakeParams(CExample_20 a_oSceneManager)
	{
