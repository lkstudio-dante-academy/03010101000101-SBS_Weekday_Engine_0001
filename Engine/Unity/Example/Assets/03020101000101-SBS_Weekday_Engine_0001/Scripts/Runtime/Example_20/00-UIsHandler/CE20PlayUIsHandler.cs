...
public class CE20PlayUIsHandler : CE20UIsHandler
{
	...
	public new record STParams : CE20UIsHandler.STParams
	{
		...
		#region 함수
		/** 생성자 */
		public STParams(CExample_20 a_oSceneManager, Vector2Int a_stGridSize) : base(a_oSceneManager)
		{
	...
	public string GetCellStateStr(CE20Engine.ECellState a_eState)
	{
		switch(a_eState)
		{
			case CE20Engine.ECellState.PLAYER_01:
				return "O";
			case CE20Engine.ECellState.PLAYER_02:
				return "X";
		}
	...
	#region 클래스 팩토리 함수
	/** 매개 변수를 생성한다 */
	public static STParams MakeParams(CExample_20 a_oSceneManager,
